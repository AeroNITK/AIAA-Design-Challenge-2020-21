...
%%% Equation number 5.9; Pg. No. 70 ( pdf pg No. 86) 
    function W_wg = Wing_Weight(Aircraft)
        ...
        %WORK PENDING
        %CHECK the /1000 in n_ult, wether to use flight design gross weight
        %instaed of Wto, does (t/c)m mean mean of root and tip
...
%%% Equation number 8.13 & 8.14; Pg. No. 312 & 313
    function Aircraft = Tail_Weight(Aircraft)
        ...
        %WORK PENDING 
        %CHECK WHICH BOOK TO USE FOR FORMULA
        ...
        W_h=0.0034*(Aircraft.Weight.MTOW*Aircraft.Vndiagram.n_ult)^0.813*(Aircraft.Tail.Horizontal.S)^0.584*(
